...
export default defineComponent({
  name: 'AboutView',
  components: { NavbarHome, PageHeader, ScrollToTop },
})
</script>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 py-0 py-lg-5">
          ...
          <p>
            Takimata sed vero vero no sit sed, justo clita duo no duo amet et, nonumy kasd sed dolor
            eos diam lorem eirmod. Amet sit amet amet no. Est nonumy sed labore eirmod sit magna.
        ...
        <div class="col-lg-4 py-0 py-lg-5">
          ...
          <h5 class="mb-3">
            <i class="fa fa-check text-primary mr-3"></i>Lorem ipsum dolor sit amet
          </h5>
          <h5 class="mb-3">
            <i class="fa fa-check text-primary mr-3"></i>Lorem ipsum dolor sit amet
          </h5>
